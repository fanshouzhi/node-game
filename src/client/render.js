...
function renderPlayer(me, player) {
    ...
    ctx.drawImage(getAsset("ball.svg"), -PLAYER.RADUIS, -PLAYER.RADUIS, PLAYER.RADUIS * 2, PLAYER.RADUIS * 2);
    ctx.restore();

    ctx.fillStyle = "white";
    ctx.fillRect(canvasX - PLAYER.RADUIS, canvasY - PLAYER.RADUIS - 8, PLAYER.RADUIS * 2, 4);
